...
Attachment = View.extend(/** @lends wp.media.view.Attachment.prototype */{
	tagName:   this.state().currentView == 'list' ? 'tr' : 'li',
	className: 'attachment',
	// template:  wp.template('attachment'),
    template:  this.state().currentView == 'list' ? wp.template('attachment-list') : wp.template('attachment'),
    attributes: function() {
...
Attachments = View.extend(/** @lends wp.media.view.Attachments.prototype */{
	tagName:   this.state().currentView == 'list' ? 'tbody' : 'ul',
	id: this.state().currentView == 'list' ? 'the-list' : 'the-grid',
	template: this.state().currentView == 'list' ? wp.template('list-table-body') : wp.template('empty-template'),

	attributes: this.state().currentView == 'list' ? {style: "width: 100%;"} : { tabIndex: -1 },
