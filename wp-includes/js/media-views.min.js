...
Attachment = View.extend(/** @lends wp.media.view.Attachment.prototype */{
	tagName: function() {
		console.log("Called with inside attachment " + this.controller.isModeActive('listView'));
...
Attachments = View.extend(/** @lends wp.media.view.Attachments.prototype */{
	...
	render: function() {
		if (!(this.controller.isModeActive('listView'))) {
			...
			_.delay( _.bind( function() {
				var theadHtml = `<thead>
				<tr>
					<th scope="col" data-sort="title" id="title" class="manage-column column-title column-primary sortable desc" abbr="File" aria-sort="none"><a><span>File</span><span class="sorting-indicators"><span class="sorting-indicator asc" aria-hidden="true"></span><span class="sorting-indicator desc" aria-hidden="true"></span></span> <span class="screen-reader-text">Sort ascending.</span></a></th>
	...
	changeSortable: function(columnName) {
		...
		collection.comparator = function (model) {
			console.log(model.attributes[columnName]);
...
AttachmentsBrowser = View.extend(/** @lends wp.media.view.AttachmentsBrowser.prototype */{
	...
	initialize: function() {
		...
		this.listenTo(this.controller, 'listView:deactivate', function() {
			console.log("Evenet deactiveat 2 list active " + this.controller.isModeActive("listView"));
			...
			this.createAttachmentsWrapperView();
			this.updateContent();
			var modelsToAdd = this.collection.models();
			modelsToAdd = modelsToAdd.map(model => model.clone());
			this.collection.add(modelsToAdd);
			console.log(this.collection);
		}, this);
	
		this.listenTo(this.controller, 'gridView:deactivate', function() {
			console.log("Evenet deactiveat 1 list active " + this.controller.isModeActive("listView"));
			if (this.attachmentsWrapper) {
				this.attachmentsWrapper.remove();
				this.stopListening(this.attachmentsWrapper);
				this.attachmentsWrapper.off();
	...
	createAttachmentsWrapperView: function() {
		// console.log("Called with " + this.controller.isModeActive('listView'));
		if (this.controller.isModeActive('listView')) {
	...
	createAttachments: function() {
		console.log("Called with 2 " + this.controller.isModeActive('listView'));
