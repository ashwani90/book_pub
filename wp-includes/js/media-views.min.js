...
Attachment = View.extend(/** @lends wp.media.view.Attachment.prototype */{
	...
	// attributes: (wp.media.controller.State.currentView == 'list') ? function () {
	// 		return {
	...
	initialize: function() {
		console.log(this.controller.isModeActive('listView'));
		console.log(this.controller.isModeActive('gridView'));
	...
	render: function() {
		...
		_.delay(_.bind( function() {
			...
			$('#view-switch-list').click(function() {
				...
				that.controller.deactivateMode('gridView').activateMode('listView');
				console.log(that.controller.isModeActive('listView'));
				console.log(that.controller.isModeActive('gridView'));
			});
			$('#view-switch-grid').click(function() {
				console.log("Click being called");
				var clickedItem = $(this);
				if (clickedItem.hasClass('current')) {
					return; 
				}
				...
				clickedItem.addClass('current');
				that.controller.deactivateMode('listView').activateMode('gridView');
				console.log(that.controller.isModeActive('gridView'));
				console.log(that.controller.isModeActive('listView'));
			});
		}, this ), 0);
