...
Attachments = View.extend(/** @lends wp.media.view.Attachments.prototype */{
	 ...
	 */
	initialize: function() {
		console.log(wp.media.controller.State.currentView);
		// if (!(wp.media.controller.State.currentView == 'list')) {
...
AttachmentsBrowser = View.extend(/** @lends wp.media.view.AttachmentsBrowser.prototype */{
	...
	initialize: function() {
		...
		wp.media.controller.State.currentView = 'grid';
		wp.media.controller.State.attachmentTemplate = null;
		wp.media.controller.State.attachmentFunction = null;
