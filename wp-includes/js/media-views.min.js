...
Toolbar = View.extend(/** @lends wp.media.view.Toolbar.prototype */{
	...
	initialize: function() {
		...
		this.primary.$el.html(`<div class="view-switch" style="height: 100%; align-content:end;margin-left: 10px;">
		...
		jQuery('#view-switch-list').click(function() {
		...
		jQuery('#view-switch-grid').click(function() {
			var $clickedItem = $(this);
			if ($clickedItem.hasClass('current')) {
				return; 
			}
