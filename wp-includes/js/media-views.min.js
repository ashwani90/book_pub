...
Attachment = View.extend(/** @lends wp.media.view.Attachment.prototype */{
	...
	initialize: function() {
		if (this.controller.isModeActive('listView') && this.collection) {
...
Details = Attachment.extend(/** @lends wp.media.view.Attachment.Details.prototype */{
	...
	replaceAttachment: function( event ) {
		...
		fileInput.addEventListener("change", function () {
			...
			let mediaId = searchParams.get('item')
			let nonce = wpApiSettings.nonce;
		
			fetch('http://localhost/book-pub/wp-json/wp/v2/media/' + mediaId, {  // Replace CURRENT_MEDIA_ID with actual media ID
				method: 'POST',
				headers: {
					"Content-Type": "image/jpeg",
					"Accept": "application/json",
					'X-WP-Nonce': nonce, // Use authentication token
				},
				body: formData
			})
			...
			.then(data => {
				if (data.id) {
					...
					document.getElementsByClassName('details-image').src = data.source_url; // Update image preview
				} else {
	...
	render: function() {
		if (!(this.controller.isModeActive('listView'))) {
			...
			_.delay( _.bind( function() {
				var theadHtml = `<thead>
				<tr>
					<th scope="col" id="file" class="manage-column" abbr="File"><a><span>File</span></a></th>
...
AttachmentsBrowser = View.extend(/** @lends wp.media.view.AttachmentsBrowser.prototype */{
	...
	initialize: function() {
		...
		this.controller.on('listView:deactivate', this.cleanUpAndRender, this);
		this.controller.on('gridView:deactivate', this.cleanUpAndRender, this);
	},

	cleanUpAndRender: function() {
		// this.undelegateEvents.apply( this, arguments );
		this.views.remove();
		// this.unbind();
		...
		*/
		...
		if ( this.controller.isModeActive( 'grid' ) ) {
			...
			this.toolbar.set( 'deleteSelectedButton', new wp.media.view.DeleteSelectedButton({
				...
				style: 'primary',
				disabled: true,
				text: mediaTrash ? l10n.trashSelected : "Delete",
				controller: this.controller,
				priority: -80,
				click: function() {
			...
			this.toolbar.set( 'bulkReplaceButton', new wp.media.view.BulkReplaceButton({
				filters: Filters,
				style: 'primary',
				disabled: true,
				text: mediaTrash ? l10n.trashSelected : "Delete",
	...
	createAttachmentsWrapperView: function() {
		if (this.controller.isModeActive('listView')) {
			this.attachmentsWrapper = new wp.media.View( {
				...
				attributes: function() {
					return {
						style: "display:block; margin: 10px; width: 80%;"
					};
				},
			} );
		} else {
