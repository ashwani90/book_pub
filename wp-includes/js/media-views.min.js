...
AttachmentsBrowser = View.extend(/** @lends wp.media.view.AttachmentsBrowser.prototype */{
	...
	initialize: function() {
		...
		// this.listenTo(this.controller, 'listView:deactivate', function() {	
		// 	// if (this.attachmentsWrapper) {
		// 	// 	this.views.remove(this.attachmentsWrapper);
		// 	// 	this.stopListening(this.attachmentsWrapper);
		// 	// 	this.attachmentsWrapper.off();
		// 	// 	this.attachmentsWrapper.remove();
		// 	// 	this.attachmentsWrapper = null;
		// 	// 	// this.dispose();
		// 	// }	
		// 	// window.media_lib = this;
		// 	this.controller.dispose();
		// 	this.controller.reset();
		// 	// this.collection.reset(this.collection);
		// 	// this.controller.views.remove();
		// 	this.views.remove(this.views.view);
		// 	if (this.collection) {
		...
		// this.listenTo(this.controller, 'gridView:deactivate', function() {
		// 	// if (this.attachmentsWrapper) {
		// 	// 	this.views.remove(this.attachmentsWrapper);
		// 	// 	this.stopListening(this.attachmentsWrapper);
		// 	// 	this.attachmentsWrapper.off();
		...
		// 	this.initialize();
		// }, this);
		this.listenTo(this.controller, 'listView:deactivate', this.refreshView);
		this.listenTo(this.controller, 'gridView:deactivate', this.refreshView);
	},
	setupView: function() {
	...
	cleanupView: function() {
		...
		this.controller.stopListening(this.controller.state(), 'reset');
	},
