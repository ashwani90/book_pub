...
Attachment = View.extend(/** @lends wp.media.view.Attachment.prototype */{
	tagName:   condition ? 'tr' : 'li',
	className: 'attachment',
	// template:  wp.template('attachment'),
    template:  condition ? wp.template('attachment-list') : wp.template('attachment'),
    attributes: function() {
		if (condition) {
			return {
...
Attachments = View.extend(/** @lends wp.media.view.Attachments.prototype */{
	tagName:   condition ? 'tbody' : 'ul',
	id: condition ? 'the-list' : 'the-grid',
	template: condition ? wp.template('list-table-body') : wp.template('empty-template'),

	attributes: condition ? {style: "width: 100%;"} : { tabIndex: -1 },
