...
Attachments = View.extend(/** @lends wp.media.view.Attachments.prototype */{
	...
	render: function() {
		var changeSortable = this.changeSortable
		_.delay(function() {
			var theadHtml = `<thead>
			<tr>
				...
				<th scope="col" data-sort="date" id="date" class="manage-column column-date sorted desc" aria-sort="descending" abbr="Date"><a ><span>Date</span><span class="sorting-indicators"><span class="sorting-indicator asc" aria-hidden="true"></span><span class="sorting-indicator desc" aria-hidden="true"></span></span></a></th>	</tr>
			</thead>`;
			...
			$('.sortable').click(function(event) {
				...
				_.debounce(changeSortable(sortColumn));
			})
		}, 0, changeSortable);
	...
	changeSortable: function(columnName) {
		...
		this.options.sortable = columnName;
