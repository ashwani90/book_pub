...
Attachment = View.extend(/** @lends wp.media.view.Attachment.prototype */{
	tagName:   (this.options && this.options.currentView == 'list') ? 'tr' : 'li',
	className: 'attachment',
	// template:  wp.template('attachment'),
    template:  (this.options && this.options.currentView == 'list') ? wp.template('attachment-list') : wp.template('attachment'),
    attributes: function() {
		if (this.options && this.options.currentView == 'list') {
			return {
...
Attachments = View.extend(/** @lends wp.media.view.Attachments.prototype */{
	tagName:   (this.options && this.options.currentView == 'list') ? 'tbody' : 'ul',
	id: (this.options && this.options.currentView == 'list') ? 'the-list' : 'the-grid',
	template: (this.options && this.options.currentView == 'list') ? wp.template('list-table-body') : wp.template('empty-template'),

	attributes: (this.options && this.options.currentView == 'list') ? {style: "width: 100%;"} : { tabIndex: -1 },
...
Toolbar = View.extend(/** @lends wp.media.view.Toolbar.prototype */{
	...
	initialize: function() {
		...
		this.viewSwitch.$el.addClass('view-switcher');
		this.viewSwitchHtml = jQuery(`<div class="view-switch">
		...
		this.viewSwitch.$el.css({
			display: "inline-block",
			height: "100%",
			alignContent: "center",
			marginTop: "10px",
		});
		this.viewSwitch.$el.prepend(this.viewSwitchHtml);

		this.views.set([ this.secondary, this.viewSwitch, this.primary, this.tertiary ]);
